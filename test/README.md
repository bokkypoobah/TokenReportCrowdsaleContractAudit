# Nuco Aion Token Contract - Testing
...
* The tests were conducted using bash shell scripts running Geth/v1.7.0-stable-6c6c7b2a/darwin-amd64/go1.7.1 JavaScript commands
